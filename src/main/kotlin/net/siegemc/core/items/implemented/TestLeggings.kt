...
class TestLeggings(override var item: ItemStack) : CustomLeggings() {

    constructor() : this(ItemStack(Material.DIAMOND_LEGGINGS))
    ...
    init {
        ...
        if (nbtItem.hasKey("customItem")) {
            ...
            nbtItem.setString("itemClass", "TestLeggings")
