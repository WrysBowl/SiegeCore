...
class RegenerationGem @Deprecated("Specify quality") constructor() : StatGemType(
    ...
    recipe = CustomRecipe(listOf(TestMaterial(0, 3), TestMaterial(0, 3), TestMaterial(0, 3), TestMaterial(0, 1), TestMaterial(0, 1), TestMaterial(0, 1), TestMaterial(0, 1), TestMaterial(0, 1), TestMaterial(0, 1))) {
        return@CustomRecipe RegenerationGem((0..100).random())
    },
