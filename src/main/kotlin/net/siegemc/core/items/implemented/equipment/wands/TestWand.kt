...
class TestWand @Deprecated("Specify quality") constructor() : CustomWand(
    ...
    recipe = CustomRecipe(listOf(null, null, TestMaterial(0, 1), TestMaterial(0, 1), null, null, null, null), true) { _: Player, fakeRarity: Boolean ->
        val item = TestWand((0..100).random())
